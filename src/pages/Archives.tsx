...
import { ArrowLeft, FileSpreadsheet, Trash2, Archive } from "lucide-react";
        ...
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{agent.name} — Historique des confirmations</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 space-y-6">
        ...
        {filtered.length === 0 ? (
          <div className="rounded-xl border bg-card p-12 text-center">
            ...
            <p className="text-muted-foreground">Aucune confirmation trouvée pour cette période.</p>
          </div>
        ) : (
